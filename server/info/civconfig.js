...
exports.civsConfig = {
  Aztecs: {
    ...
    enabled: {
      units: [EAGLE_SCOUT, EAGLE_WARRIOR, ELITE_EAGLE_WARRIOR, XOLOTL_WARRIOR],
    },
  ...
  Huns: {
    disabled: {
      buildings: [GUARD_TOWER, KEEP, BOMBARD_TOWER, FORTIFIED_WALL, HOUSE],
      techs: [
        SHIPWRIGHT,
        GUARD_TOWER_TECH,
        KEEP_TECH,
  ...
  Incas: {
    ...
    disabled: {
      buildings: [BOMBARD_TOWER],
      techs: [BOMBARD_TOWER_TECH, ATONEMENT, FERVOR, ARCHITECTURE, TWO_MAN_SAW],
      units: [
        HAND_CANNONEER,
        CANNON_GALLEON,
        ELITE_CANNON_GALLEON,
    ...
    monkPrefix: MONK_PREFIX_MESO,
    unique: [KAMAYUK, ELITE_KAMAYUK, ANDEAN_SLING, FABRIC_SHIELDS],
  },
  Indians: {
    disabled: {
      buildings: [KEEP, BOMBARD_TOWER],
  ...
  Magyars: {
    ...
    unique: [MAGYAR_HUSZAR, ELITE_MAGYAR_HUSZAR, CORVINIAN_ARMY, RECURVE_BOW],
  },
  Malay: {
    disabled: {
  ...
  Tatars: {
    ...
    enabled: {
      units: [STEPPE_LANCER, ELITE_STEPPE_LANCER, FLAMING_CAMEL],
    },
 ...
 * Unique Buildings
 */
exports.disabledBuildings = [KREPOST, FEITORIA];

/**
 * Not often enabled
 */
exports.disabledUnits = [
...
exports.counters = [
  ...
  {
    name: "Light Cavalry",
    units: [SCOUT_CAVALRY, LIGHT_CAVALRY, HUSSAR],
    counters: [SPEARMAN, PIKEMAN, HALBERDIER, CAMEL_RIDER, HEAVY_CAMEL_RIDER],
  },
  {
    name: "Skirmisher Line",
    units: [SKIRMISHER, ELITE_SKIRMISHER],
    counters: [
      MAN_AT_ARMS,
      LONG_SWORDSMAN,
  ...
  {
    name: "Militia Line",
    units: [MAN_AT_ARMS, LONG_SWORDSMAN, TWO_HANDED_SWORDSMAN, CHAMPION],
    counters: [
      ARCHER,
      CROSSBOWMAN,
      ARBALESTER,
  ...
  },
  {
    ...
    units: [CAVALRY_ARCHER, HEAVY_CAV_ARCHER],
    counters: [
      CAMEL_RIDER,
      HEAVY_CAMEL_RIDER,
      MANGONEL,
